...
import MyBidSpeci from '../../components/MyBidSpeci';
    ...
    return (
        ...
        <div>
            ...
            <div className="container body">
                ...
                <Speci className='rabotniki' isActive={isActive} speci={sortdedRabotniki}/>
                <MyBidSpeci className='myAdvertisement' isActive={isActive} speci={speci} bids={bid}/>               
