...
calculate();
    ...
    function say(){
        alert("Привет! Заинтересовался моими работами? Тогда у меня хорошая новость: на данный момент ты можешь получить скидку 30% на своей первый заказ (смотри в разделе ...)");
    }
