...
const EmpProfile = () => {
    ...
    const changeProfileSettings = (e) => {
        ...
        if(flag){
            ...
            document.querySelector('.upArrowSity').style.pointerEvents = 'auto'
            flag = false
        } else {
            document.querySelectorAll('input').forEach((e) => {e.setAttribute('readonly', '')}) 
            document.querySelector('textarea').setAttribute('readonly', '')
            document.querySelector('.upArrowSity').style.pointerEvents = 'none'
            flag = true
        }
    }
    ...
    return (
        <div className='EmpProfile'>
            ...
            <div className="container">
                <button className='button' onClick={changeProfileSettings}>Редактировать профиль</button>
                <div className="row">
                ...
                <div className="row">
                    <div className="col-12">
                        ...
                        <img src={upArrowSity} className='upArrowSity disabledMenu' onClick={watchSitySpec} style={{pointerEvents: 'none'}}/>
                        </div>
