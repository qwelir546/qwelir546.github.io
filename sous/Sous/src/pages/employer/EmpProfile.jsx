                ...
                <div className="row">
                    ...
                    <div className="col-xl-8 col-lg-7 col-sm-7 col-12 main-info">
                        ...
                        <div className="item-border mail_item">
                            <div className="mail item col-xl-10 col-lg-9 col-sm-8 col-9">Почта:&#8195;<input type="text" class="input_back input-mail col-xl-10 col-sm-10 col-11" 
                            placeholder='ваша почта' readonly='true'/></div>
                            <button className="transform-mail transform-button transform-button_height" onClick={change}>изменить</button>
                        </div>
                        <div className="item-border password_item">
                            <div className="password item col-xl-10 col-lg-9 col-sm-8 col-9">Пароль:&#8195;<input type="text" class="input_back input-password col-xl-9 col-sm-8 col-11" 
                            placeholder='ваш пароль' readonly='true'/></div>
                            <button className="transform-password transform-button transform-button_height " onClick={change}>изменить</button>
                        </div>
                    </div>
                </div>
                <div className="row">
                    <div className="col-12">
                        <div className="item-border nameMobile mar-top" style={{display: 'none'}}>
                            <div className="name item col-sm-10 col-9">Имя:&#8195;<input type="text" class="input_back input-name  col-sm-9 col-11" 
                            placeholder='ваше имя' readonly='true' defaultValue='anton'/></div>
                            <button className="transform-name transform-button" onClick={change}>изменить</button>
                        </div>
                        <div className="item-border mar-top">
                            <div className="sity1 item col-sm-10 col-9">Город:&#8195;<input type="text" class="input_back input-sity col-sm-9  col-11" 
                        ...
                        <div className="item-border">
                            <div className="phone item col-sm-10 col-9">Телефон:&#8195;<input type="text" class="input_back input-phone col-sm-9 col-11" 
                            placeholder='телефон (необязательно)' readonly='true'/></div>
                            <button className="transform-phone transform-button" onClick={change}>изменить</button>
                        </div>
                        <div className="item-border">
                            <div className="field item col-sm-10 col-9">Адрес основного объекта:&#8195;<input type="text" class="input_back input-field col-sm-7 col-11" 
                            placeholder='ул. ... , дом 00' readonly='true'/></div>
                            <button className="transform-field transform-button transform-button_height" onClick={change}>изменить</button>
                        </div>
                        <div className="item-border">
                            <div className="field item col-sm-10 col-9">Все объекты:&#8195;<input type="text" class="input_back input-field col-xl-8 col-sm-9 col-11" 
                            placeholder='прочие объекты компании' readonly='true'/></div>
                            <button className="transform-field transform-button transform-button_height" onClick={change}>изменить</button>
                        </div>
                        <div className="item-border no">
                            <textarea type="text" class="input_back input-field col-12" placeholder='Об организации'/>
                        </div>
                    </div>
                </div>
            </div>
